...
public class sceneController {
    ...
    void handlesearchButton(ActionEvent event) {
        ...
        else
    	{
            ...
            if (numResults == 1)
            {
            	totalSearchResults.setText("Based on your search there was " + numResults + " person found.");
            }
            else
            {
            	 totalSearchResults.setText("Based on your search there were " + numResults + " people found.");
            }      
    	}
